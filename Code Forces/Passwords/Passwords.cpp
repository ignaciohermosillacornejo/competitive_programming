/*
Problem: https://codeforces.com/contest/721/problem/B
Tags: Sorting, Implementation, Math, Strings
Status: Accepted
*/
...
int main()
{
    ...
    for (auto i = 0; i < int(word_list.size()); i++)
    {
        ...
        if (word_list[i].length() < p_length)
            pre_counter++;
        else if (word_list[i].length() == p_length)
            post_counter++;
        else
            break;
    }
